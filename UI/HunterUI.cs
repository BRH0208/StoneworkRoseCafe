...
namespace StoneworkRoseCafe.UI
{
	internal class HunterUI : UIState
	{
		...
		public override void Update(GameTime gameTime) {
			...
			if (Main.LocalPlayer.talkNPC == -1 || Main.npc[Main.LocalPlayer.talkNPC].type != NPCType<Hunter>()) {
				...
				GetInstance<StoneworkRoseCafe>().HunterUserInterface.SetState(null);
			}
		}
